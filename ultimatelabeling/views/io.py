    ...
    def on_import_click(self):
        ...
        for file_name in self.state.get_file_names():
            if file_name in imported_base_names:
                ...
                df = pd.read_csv(imported_files[idx], names=["class_id", "action_id", "xc", "yc", "w", "h"], sep=" ", header=None, index_col=False)
                ...
                df = df[["track_id", "class_id", "action_id" "x", "y", "w", "h", "polygon", "kp"]]
